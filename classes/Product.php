...
<?php
    ...
    class Product
    {
         ...
         * @return bool
         */
        public function showSueteresProduct()
        {
            return $this->db->select("SELECT * FROM ecom_product WHERE catid = 12 ORDER BY proid LIMIT 3");
        }

        /**
         * @return bool
         */
        public function showChamarrasProduct()
        {
            return $this->db->select("SELECT * FROM ecom_product WHERE catid = 13 ORDER BY proid LIMIT 3");
        }

        /**
         * @return bool
         */
        public function showBlusasProduct()
        {
            return $this->db->select("SELECT * FROM ecom_product WHERE catid = 14 ORDER BY proid LIMIT 3");
        }
         ...
         * 
         */
        public function showCamisasProduct()
        {
            return $this->db->select("SELECT * FROM ecom_product WHERE catid = 15 ORDER BY proid LIMIT 3");
        }
        ...
        public function showPantalonesProduct()
        {
        ...
        public function showVestidosProduct()
        {
