        ...
        <div class="container">
            ...
            <div class="search">
                ...
                <?php if ( ($_SERVER['REQUEST_METHOD'] == 'POST') && isset($_POST['search']) ):  ?>
                    <?php
                    $id = $productObject->searchProduct($_POST['Buscar']);
                    if ($id)
                    {
                            ...
                            <table class="table">
                                <thead class="table table-bordered">
                                    <tr>
                                        ...
                                        <th class="text-center" style="width: 8%;">Precio</th>
                                        <th class="text-center" style="width: 24%;">Imagen</th>
                                        <th class="text-center" style="width: 22%;">Modificar</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <form class="navbar-form navbar-left" method="post" action="">
                                                    ...
                                                    <button type="submit" class="btn btn-default w3ls-cart" name="updateCart" > <i class="fa fa-check"></i> Modificar</button>
                                                </form>
                                            </td>
                                            <?php  ?>
                                            <td class="text-center">
                                                <a href="?delCart=<?php echo $allCart['cartid']; ?>" onclick="return confirm('Estás seguro de que quieres Eliminar? ?');" class="btn btn-danger"> <i class="fa fa-pencil-square-o"></i> Eliminar </a>
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>
                                </tbody>
                ...
                <?php else: ?>
                    <?php
                        echo "<div class='alert alert-danger alert-dismissable'>
                              ...
                              <strong> Warning !</strong> El carro está vacío.
                          </div>";
                    ?>
                <?php endif; ?>
                <?php if (!$emptyCart): ?>
                ...
                <?php else: ?>
                    <div class="col-md-4 col-lg-4 col-sm-4 col-xs-4 pull-right hover">
                        <div class="cart-info" style="background-color: #d9edf7; padding: 15%;box-shadow: 5px 4px 18px #888888;border-radius: 3%; font-weight: 700">
                            <p> Precio Total :  $<?php echo $total; Session::set("total", $total); ?>  </p>
                            <p> IVA :  5% </p>
                            <p>Total con IVA :  $<?php echo ($total+(($total*5)/100)); ?> </p>
                        </div>
                        <div class="checkout-button" style="box-shadow: 5px 4px 18px #888888;">
                            <a class="btn btn-block btn-warning text-capitalize" href="payment.php">Pagar</a>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
