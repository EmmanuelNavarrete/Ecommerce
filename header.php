                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                &times;</button>
                            <h4 class="modal-title" id="myModalLabel">Debes registrarte para poder entrar. si ya tienes una cuenta Loggeate!</h4>
                        </div>
                                                ...
                                                <div class="facts">
                                                    <div class="register">
                                                        <form action="#" method="POST">
                                                            ...
                                                            <div class="sign-up">
                                                                <input type="submit" name="singin" value="Entrar"/>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="facts">
                                                    <div class="register">
                                                        <form action="#" method="POST">
                                                            ...
                                                            <input placeholder="Dirección de correo electronico" name="Email" type="email"  />
                                                            <input placeholder="Numero de telefono" name="Phone" type="text" style="margin-top: 15px" />
                                                            <input placeholder="Contraseña" name="Password" type="password"  />
                                                            <input placeholder="Confirma tu contraseña" name="rePassword" type="password"  />
                                                            <div class="sign-up">
