                    ...
                    <div class="col-md-8 single-right">
                        ...
                        <div class="simpleCart_shelfItem">
                            ...
                            <form class="navbar-form navbar-left" method="post" action="">
                                ...
                                <button type="submit" class="btn btn-default w3ls-cart" name="addCart" >Agregar al carritot</button>
                            </form>
                        </div>
                    </div>
            <!--End-->
				...
				<div id="horizontalTab1" style="display: block; width: 100%; margin: 0px;">
					...
					<div class="tab-2 resp-tab-content additional_info_grid" aria-labelledby="tab_item-1">
						...
						<div class="review_grids">
							<h5>gregar nueva reseña</h5>
                            <form action="#review" id="review" method="post">
                                <div class="form-group">
                                    <label for="usr">Nombre:</label>
                                    <input type="text" class="form-control" name="Name" id="usr" placeholder="Tu nombre" />
                                </div>
                                <div class="form-group" style="position: relative;right: 15px;">
                                    <label for="pwd" style="position: relative;left: 15px;">E-mail:</label>
                                    <input type="email" name="Email" class="form-control" id="pwd" placeholder="Correo electronico" />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="Telephone" class="form-control" id="ph" placeholder="Tu telefono" />
                                </div>
                                <div class="form-group">
                                    <label for="comment">Reseña:</label>
                                    <textarea class="form-control" name="Review" rows="5" id="comment" placeholder="Tu reseña"></textarea>
                                </div>
                                <div class="form-group">
