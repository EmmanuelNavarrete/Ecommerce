                        ...
                        <div class="cart-table">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" style="width: 16.66%;">Nombre</th>
                                    <th class="text-center" style="width: 16.66%;">Precio</th>
                                    <th class="text-center" style="width: 16.66%;">Cantidad</th>
                                    <th class="text-center" style="width: 16.66%;">Total</th>
                                    <th class="text-center" style="width: 16.66%;">Imagen</th>
                                </tr>
                                </thead>
